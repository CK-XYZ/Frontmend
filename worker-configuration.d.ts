/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1fceb1fc38391a32e57618cd2bbf1564)
// Runtime types generated with workerd@1.20260825.1 2026-08-27
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	AUDIT_GATE: DurableObjectNamespace<import("./worker/index").FrontmendAuditGate>;
	AUDIT_JOBS: DurableObjectNamespace<import("./worker/index").FrontmendAuditJob>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "FrontmendAuditGate" | "FrontmendAuditJob";
	}
