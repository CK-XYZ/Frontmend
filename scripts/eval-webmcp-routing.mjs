...
const CONTEXTS = Object.freeze({
  ...
  diagnosisRequired: ["get_mission_summary", "get_site_audit_results", "get_evidence_chain", "open_diagnostic_mission"],
  diagnosisActive: ["get_mission_summary", "get_site_audit_results", "get_evidence_chain", "submit_runtime_diagnosis", "record_diagnostic_blocker"],
  assessed: ["get_mission_summary", "get_site_audit_results", "get_evidence_chain", "get_assessment_receipt", "get_repository_fix_brief", "prepare_site_repair"],
  prepared: ["get_mission_summary", "get_site_audit_results", "get_evidence_chain", "get_repair_workspace", "stage_site_repair"],
...
const ROUTING_CASES = Object.freeze([
  ...
  { id: "compact-next-step", context: "diagnosisActive", prompt: "What is the exact next step in this mission?", expected: ["get_mission_summary"], outcome: "blocked" },
  ...
  { id: "open-diagnosis", context: "diagnosisRequired", prompt: "Open the repository diagnosis for this retained symptom.", expected: ["open_diagnostic_mission"], outcome: "blocked" },
  { id: "submit-diagnosis", context: "diagnosisActive", prompt: "I reproduced the issue and mapped its repository owner; submit the diagnosis.", expected: ["submit_runtime_diagnosis"], outcome: "complete" },
  { id: "record-diagnosis-blocker", context: "diagnosisActive", prompt: "The correct repository is unavailable; record an honest blocker.", expected: ["record_diagnostic_blocker"], outcome: "blocked" },
  ...
  { id: "prepare-explicit-fix", context: "assessed", prompt: "Prepare the first diagnosed priority for a fix.", expected: ["prepare_site_repair"], outcome: "blocked" },
...
function selectTool(prompt, discoveredTools) {
  ...
  const candidates = [
    ...
    [/open .*diagnosis/, "open_diagnostic_mission"],
